<template>
    <div class="text-center">
        <v-overlay opacity="1" :value="overlay" absolute>
            <v-progress-circular indeterminate size="300" color="primary">
                <!-- <div class="sea">
                ...
                <div>
                    <v-img contain height="50" src="https://icon-library.net/images/launch-icon/launch-icon-17.jpg">
                    </v-img>
                    <div class="headline mt-5 white--text">Launching {{ name }}</div>
                </div>
            </v-progress-circular>
            <!-- <div class="headline mt-5 white--text">Launching {{ name }}</div> -->
        </v-overlay>
...
<style>
    ...
    *:after {
    ...
    .sea .submarine-wrapper .submarine-body {
        ...
        border-radius: 40px;
        background: linear-gradient(rgb(217, 201, 58), #bcb924);
    }
