        ...
        <v-dialog v-model="dialog">
            ...
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-checkbox class="pa-0" v-model="duplicateParticipants" label="Duplicate Participants"></v-checkbox>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
    ...
    export default {
        ...
        data() {
            ...
            submit(){
                ...
                self.post(`dt_draw/duplicate?duplicatePrizes=${self.duplicatePrizes}&duplicateParticipants=${self.duplicateParticipants}`,self.draw).then(r=>{
                    console.log(r.data);
                    self.dialog=false
